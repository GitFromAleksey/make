 ...
 * \note Configuration of hook extension is available in Ifx_Cfg_Trap at path ../0_Src/0_AppSw/Tricore/McHalCfg/
 *
 * \code
 * //file: Ifx_Cfg_Trap.h
 *
 ...
 * \note Configuration of hook extension is available in Ifx_Cfg_Trap file at path ../0_Src/0_AppSw/Tricore/McHalCfg/
 * \code
 * //file: Ifx_Cfg_Trap.h
 *
 * #include "Ifx_TrapExtension.h" //Assuming this is the file name as in above example
