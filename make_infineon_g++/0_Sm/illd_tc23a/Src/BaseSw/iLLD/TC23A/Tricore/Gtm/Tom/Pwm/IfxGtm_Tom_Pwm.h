 ...
 * \param config configuration structure for the channel
 * \return None
 */
IFX_EXTERN void IfxGtm_Tom_Pwm_start(IfxGtm_Tom_Pwm_Driver *driver, IfxGtm_Tom_Pwm_Config *config);
 ...
 * \return None
 */
IFX_EXTERN void IfxGtm_Tom_Pwm_stop(IfxGtm_Tom_Pwm_Driver *driver, IfxGtm_Tom_Pwm_Config *config);
