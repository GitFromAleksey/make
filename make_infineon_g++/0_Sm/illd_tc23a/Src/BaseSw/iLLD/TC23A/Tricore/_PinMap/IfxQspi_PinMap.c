...
IfxQspi_Mrst_In IfxQspi0_MRSTD_P14_6_IN = {&MODULE_QSPI0, {&MODULE_P14, 6}, Ifx_RxSel_d};
...
IfxQspi_Mtsr_In IfxQspi1_MTSRC_P11_8_IN = {&MODULE_QSPI1, {&MODULE_P11, 8}, Ifx_RxSel_c};
...
IfxQspi_Mtsr_Out IfxQspi1_MTSR_P11_8_OUT = {&MODULE_QSPI1, {&MODULE_P11, 8}, IfxPort_OutputIdx_alt4};
IfxQspi_Mtsr_Out IfxQspi1_MTSR_P11_9_OUT = {&MODULE_QSPI1, {&MODULE_P11, 9}, IfxPort_OutputIdx_alt3};
IfxQspi_Mtsr_Out IfxQspi2_MTSR_P13_3_OUT = {&MODULE_QSPI2, {&MODULE_P13, 3}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Sclk_Out IfxQspi2_SCLK_P13_0_OUT = {&MODULE_QSPI2, {&MODULE_P13, 0}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Slso_Out IfxQspi1_SLSO10_P11_8_OUT = {&MODULE_QSPI1, 10, {&MODULE_P11, 8}, IfxPort_OutputIdx_alt3};
